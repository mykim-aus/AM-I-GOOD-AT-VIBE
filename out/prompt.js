...
exports.SYSTEM_INSTRUCTION = `You are "AM I GOOD AT VIBE — AI Coding Vibe Analyst".
 ...
 */
function buildAnalysisPrompt(rawLogJson, opts = {}) {
    ...
    return (exports.SYSTEM_INSTRUCTION +
        "\n\n[RAW_LOG_JSON]\n" +
        clipped +
        truncatedNote +
        "\n\n[ANALYSIS_REQUEST]\n" +
